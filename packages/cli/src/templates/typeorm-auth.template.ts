...
/**
 * TypeORM-compatible auth templates.
 * Same functionality as the Prisma/Mongoose auth templates.
 */

export const getTypeOrmAuthController = (): string => `import {
  Body,
  Controller,
  Post,
  HttpCode,
...
export const getTypeOrmAuthService = (): string => `import { Injectable, UnauthorizedException } from '@nestjs/common';
...
export const getTypeOrmAuthModule = (): string => `import { Module } from '@nestjs/common';
import { AuthService } from './auth.service';
...
export const getTypeOrmAuthGuard = (): string => `import {
  CanActivate,
  ExecutionContext,
  Injectable,
...
export const getTypeOrmJwtConstants = (): string => `import { randomBytes } from 'crypto';
